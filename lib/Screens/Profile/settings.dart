            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                ListTile(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: Text(
                              widget.currentUser.phoneNumber != null ? "${widget.currentUser.phoneNumber}" : "Verify Now".tr().toString(),
                  ...
                  subtitle: Text("Verify a phone number to secure your account".tr().toString()),
                ),
                Padding(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  var address = await Navigator.push(context, MaterialPageRoute(builder: (context) => UpdateLocation()));
                                  print(address);
                                  if (address != null) {
                                                ...
                                                showDialog(
                                                  ...
                                                  builder: (BuildContext context) {
                                                    return AlertDialog(
                                                      ...
                                                      content: Text('Do you want to change the language to English?'.tr().toString()),
                                                      actions: <Widget>[
                                                        FlatButton(
                                                        ...
                                                        FlatButton(
                                                          onPressed: () {
                                                            ...
                                                            Navigator.push(context, MaterialPageRoute(builder: (context) => Tabbar(null, false)));
                                                          },
                                              ...
                                              onPressed: () async {
                                                showDialog(
                                                  ...
                                                  builder: (BuildContext context) {
                                                    return AlertDialog(
                                                      title: Text("Change Language".tr().toString()),
                                                      content: Text('Do you want to change the language to Spanish?'.tr().toString()),
                                                      actions: <Widget>[
                                                        FlatButton(
                                                          onPressed: () => Navigator.of(context).pop(false),
                                                          child: Text('No'.tr().toString()),
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Share.share('check out my website https://simplemarriagetg.page.link/bjYi', //Replace with your dynamic link and msg for invite users
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: Text('Do you want to delete your account?'.tr().toString()),
                            actions: <Widget>[
                              FlatButton(
                                onPressed: () => Navigator.of(context).pop(false),
                                child: Text('No'.tr().toString()),
                ...
                RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    await Firestore.instance
                        ...
                        .updateData({
                          'location': {'latitude': _address['latitude'], 'longitude': _address['longitude'], 'address': _address['PlaceName']},
                        })
